                        ...
                        <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                          ...
                          {g.image_url && (
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 text-xs bg-amber-50 hover:bg-amber-100 text-amber-900 px-2 py-0.5 rounded-md border border-amber-300 font-semibold cursor-pointer transition shadow-xs group"
                              title="Click to view full-size photo"
                            >
                              <img
                                src={g.image_url}
                                alt="Thumbnail"
                                className="w-5 h-5 rounded object-cover border border-amber-400 group-hover:scale-110 transition"
                              />
                          ...
                          {cmp.image_url && (
                            <div className="pt-1">
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 text-[11px] bg-amber-50 hover:bg-amber-100 text-amber-900 px-2 py-1 rounded border border-amber-300 font-semibold cursor-pointer transition"
                              >
                                <img
                                  src={cmp.image_url}
                                  alt="Photo Evidence"
              ...
              {statusModalGrievance.image_url && (
                <div className="mt-2.5 pt-2.5 border-t border-gray-200">
                  <p className="text-xs font-semibold text-gray-700 mb-1.5 flex items-center gap-1">
                    <span>📸 Citizen Uploaded Photo:</span>
                  </p>
                  <div className="relative group inline-block">
                    <img
                      src={statusModalGrievance.image_url}
                      alt="Grievance Evidence"
                      onClick={() =>
                        setPreviewImageModal({
                          url: statusModalGrievance.image_url,
                          title: `Grievance #${statusModalGrievance.id.slice(0, 6)}`,
                          caption: statusModalGrievance.text,
                          location: statusModalGrievance.location,
                        })
                      }
                      className="h-32 w-auto max-w-full rounded-lg border-2 border-gray-300 object-cover shadow-xs cursor-pointer hover:opacity-90 hover:border-brand-500 transition"
                    />
                    <button
                      type="button"
                      onClick={() =>
                      ...
                      className="mt-1 text-[11px] text-brand-600 hover:text-brand-800 font-semibold flex items-center gap-1 cursor-pointer"
                    >
            ...
            {selectedGrievance.image_url && (
              <div className="mb-4">
                ...
                <img
                  ...
                  className="h-44 object-cover rounded-lg border border-gray-200 cursor-pointer hover:opacity-90 hover:border-brand-500 transition shadow-xs"
                />
                <button
                  type="button"
                  onClick={() =>
          ...
          >
            ...
            <div className="p-4 bg-gray-950 flex items-center justify-center overflow-auto max-h-[65vh]">
              <img
                ...
                className="max-h-[60vh] max-w-full object-contain rounded-lg shadow-lg border border-gray-800"
              />
            </div>
            ...
            {previewImageModal.caption && (
              <div className="p-3.5 bg-gray-50 border-t border-gray-200 text-xs text-gray-700">
                <p className="font-semibold text-gray-900 mb-0.5">Reported Complaint Description:</p>
            ...
            <div className="p-3 bg-gray-100 border-t border-gray-200 flex justify-between items-center text-xs">
              ...
              <button
                onClick={() => setPreviewImageModal(null)}
                className="px-4 py-1.5 bg-gray-800 hover:bg-gray-900 text-white rounded-lg font-medium cursor-pointer"
              >
                Close Preview
              </button>
            </div>
